...
export default function ProfileCard() {
  return (
    <>
      <Card className="font-inter flex max-h-122 w-70 min-w-full flex-col items-center text-[#47484B]">
        ...
        <div>
          ...
          <div className="mt-8 flex w-full justify-center gap-8 [&>div>p]:text-center">
            <div>
          ...
          <div className="mt-5 mb-5 flex w-full justify-center md:mt-3 md:mb-2">
            <button className="font-inter h-11 w-[80%] cursor-pointer rounded-[5px] bg-(--colorPurple) text-[14px] font-semibold tracking-wider text-(--colorBox) transition-transform duration-200 active:scale-95 md:w-[90%]">
              View More
            </button>
          </div>
        </div>
