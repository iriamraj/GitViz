export default function SearchBar() {
  return (
    <div className="font-inter mt-10 flex w-[95%] max-w-185.25 flex-col items-center gap-[min(6vw,31px)] font-medium md:flex-row">
      ...
      <button className="h-[min(10vw,47px)] w-[min(33vw,162px)] cursor-pointer rounded-full bg-(--colorPurple) text-[min(3.7vw,16px)] text-(--colorBox) shadow-[0_0_10px_5px_#6F60B530]">
        Visualize Now
      </button>
    </div>
  );
