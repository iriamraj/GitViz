...
export default function Footer() {
	...
	return (
		<footer id="Footer" className="w-full flex flex-col justify-center items-center">
			<div className="flex flex-col gap-5 md:gap-20 md:flex-row">
				<div className=" flex flex-col items-center md:items-start">
					...
					<p
						className={`leading-7 w-60 mt-4 text-center md:text-start ${isDark && "text-(--colorTextDark)"} transition-colors duration-300`}
					>
			...
			<div
				className={`mt-8 flex items-center gap-3 mb-5 ${isDark && "text-(--colorTextDark)"} transition-colors duration-300`}
			>
				<img src={gitIcon} alt="" className="w-5" />
				<p>Source Code</p>
			</div>
